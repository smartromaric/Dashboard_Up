...
def aggregate_status_breakdown(
    ...
    for status, count in (by_status or {}).items():
        ...
        if "desapprouv" in s or "rejet" in s or "refus" in s:
            rejected += c
        elif "attente" in s:
            pending += c
        elif "approuv" in s:
...
def build_executive_summary(
    ...
    *,
    ...
    drivers = aggregate_status_breakdown(dbs, totals.get("drivers"))
...
def render_global(
    ...
    *,
    ...
    kpis = kpi_block(
        ...
        [
            (str(drivers_pending), "Conducteurs en attente"),
...
def render_campaign(
    ...
    kpis = kpi_block(
        [
            ...
            (str(len(drv_pend)), "Conducteurs en attente"),
        ],
        [
